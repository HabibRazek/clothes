...
import { loginAction, type LoginFormData } from "@/lib/actions/auth"
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-sm text-[#09B1BA] hover:underline">
                    {t('forgotPassword')}
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="text-center pt-4 border-t border-gray-100">
              <p className="text-sm text-gray-600">
                {t('dontHaveAccount')} <Link href="/signup" className="text-[#09B1BA] hover:underline font-medium">{t('createAccount')}</Link>
              </p>
            </div>
          </CardContent>
        </Card>
